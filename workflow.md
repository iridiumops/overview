...
2) Install [Anaconda or Miniconda](https://www.anaconda.com/download/success). Create or update your Python environment and setup dependencies via `requirements/create.bat` script.
